 ...
 * @author pc
 */
@WebServlet(name = "AddToCartFromSearchServlet", urlPatterns = {"/addToCartFromSearchPage"})
public class AddToCartFromSearchServlet extends HttpServlet {
    private CartDAOImpl cartDAOImpl;
    private ItemBookDAOImpl itemBookDAOImpl;

    public AddToCartFromSearchServlet() {
    ...
    private void addToCart(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        request.setAttribute("barcode", itemBarcode);
        request.setAttribute("bookTitle", request.getAttribute("bookTitle"));
